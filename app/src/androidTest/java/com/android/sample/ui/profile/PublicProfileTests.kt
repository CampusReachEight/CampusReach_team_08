...
class PublicProfileTests {
    ...
    fun staticPublicProfileScreen_displaysProvidedProfile_valuesAndStats() {
        ...
        composeTestRule.onNodeWithTag(ProfileTestTags.PROFILE_STAT_BOTTOM_HELP_RECEIVED).assertIsDisplayed()
        ...
        composeTestRule.onNodeWithTag(ProfileTestTags.PROFILE_STAT_TOP_KUDOS).assertTextEquals("7")
        composeTestRule.onNodeWithTag(ProfileTestTags.PROFILE_STAT_BOTTOM_HELP_RECEIVED).assertTextEquals("8")
        composeTestRule.onNodeWithTag(ProfileTestTags.PROFILE_STAT_TOP_FOLLOWERS).assertTextEquals("9")
        composeTestRule.onNodeWithTag(ProfileTestTags.PROFILE_STAT_BOTTOM_FOLLOWING).assertTextEquals("10")
    }
