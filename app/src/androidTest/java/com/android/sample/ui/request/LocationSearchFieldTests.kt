...
class LocationSearchFieldTest {
    ...
    /**
     * Helper function to generate LocationSearchField with default values.
    ...
    fun locationSearchField_noLocation_doesNotDisplayCard() {
        ...
        composeTestRule.onNodeWithTag(LocationSearchFieldTestTags.SelectedLocationCard).assertDoesNotExist()
