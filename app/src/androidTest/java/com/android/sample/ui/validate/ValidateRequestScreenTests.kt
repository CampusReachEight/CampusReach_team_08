...
class ValidateRequestScreenTest {
    ...
    fun confirmingState_confirmButtonClick_awardBatchFails_callsRetry() {
        ...
        fakeUserProfileRepository = FakeUserProfileRepository(listOf(helper), failAwardFor = setOf(helper.id))
    ...
    fun confirmingState_confirmButtonClick_receiveHelpFails_callsRetry() {
        ...
        setUpScreen(state = TestDataFactory.createConfirmingState(selectedHelpers = listOf(helper1, helper2)))
...
private class FakeUserProfileRepository(
    ...
    override suspend fun awardKudos(userId: String, amount: Int) {
        ...
        val profile =
            profileCache[userId] ?: throw NoSuchElementException("Profile not found: $userId")
    ...
    override suspend fun receiveHelp(userId: String, amount: Int) {
        ...
        if (!profileCache.containsKey(userId)) throw NoSuchElementException("Profile not found: $userId")
