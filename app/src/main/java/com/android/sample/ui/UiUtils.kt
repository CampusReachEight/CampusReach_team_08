...
class UiUtils {
    ...
    /**
     * Truncates a given text to fit within a specified maximum length, optionally preserving
     * a suffix (e.g., domain in an email) and appending an ellipsis ("...") to indicate truncation.
     *
     * @param text The input string to be truncated.
     * @param maxLength The maximum allowed length of the resulting string, including the ellipsis.
     *                  Must be greater than or equal to 1.
     * @param keepSuffixLength The number of characters to preserve at the end of the string.
     *                         Useful for keeping domains or other important suffixes. Defaults to 0.
