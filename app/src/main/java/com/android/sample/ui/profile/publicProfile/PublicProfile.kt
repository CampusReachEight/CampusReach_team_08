 ...
 *
 * This model contains only the data required by the public profile screen and is safe to
 * pass between layers (ViewModel \-> UI) and to use in tests.
 *
 * @property userId Unique identifier of the user. Expected to be non-empty when representing a real user.
 * @property name Display name shown in the UI.
 * @property section Short subtitle/role or section text shown under the name.
 * @property arrivalDate Optional arrival date formatted for display (e.g. `"Jan 1, 2020"`). Use `null`
