...
You qualified for a Black Belt 🥋⚫ and got a final grade of 5.87/6 for M2. Fantastic! You've demonstrated true mastery. 
...
|------------------------------------------|--------------------------------|------------|-------------------------------------------|
| **Implementation (APK, code quality)**   | 5.99 out of 6 | 40%        | [See Details](#implementation-apk-code-quality) |
...
- We noticed some magic values in your code, but you have improved significantly in managing them. Keep up the progress by continuing to extract remaining magic values into constants.

- The same applies to strings. Strings should be placed in a separate file for better maintainability, and you’ve made noticeable improvements in this area as well. Keep ensuring that all hard-coded strings are handled properly.

For this part, you received 5.99 points out of a maximum of 6.
...
- Your Figma is complete and up to date with the app, which is great. However, it wasn’t always ahead of the app development. The mockups look good overall, but for the wireframes, we suggest making the transition arrows clearer to improve readability.

- Regarding the architecture, everything is good in general. One improvement would be to be more specific when labeling “API calls.” Indicate which APIs are being used and list them if necessary for clarity.
...
- Make sure to provide detailed comments on your issues. Break them down into multiple points and clearly describe the technical steps required to complete the task. This ensures clarity for both you and the team when working on or reviewing the issue.
...
Your team grade for milestone M2 is 5.87/6. If you are interested in how this fits into the bigger grading scheme, please see [project README](https://github.com/swent-epfl/public/blob/main/project/README.md) and the [course README](https://github.com/swent-epfl/public/blob/main/README.md).
